...
**Hello Rails React** is a sample project that uses REACT for frontend and Rails for backend 
...
```sh
  git clone https://github.com/dazehinn/hello-rails-react.git
```
Open your terminal and navigate to the cloned project directory.

### Install

To setup the environment for this project run the two commands below:
...
Feel free to check the [issues page](https://github.com/dazehinn/hello-rails-react/issues/).
